...
def validate_entry(entry: Dict[str, Any], schemas_dir: str = "data/schemas", schema_key: Optional[str] = None) -> List[str]:
...
def main() -> int:
    ...
    ap.add_argument("--schemas-dir", default="data/schemas", help="Directory containing *.json schemas (default: data/schemas)")
