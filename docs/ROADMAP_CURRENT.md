...
> Last updated: 2026-05-18 (B252 ✅ — engine fix di D238 §5.5 finding 1. `suggest_max_hang_load` ora deriva `protocol_version` da `hang_seconds` invece di hardcode `"max_hang_5s.v1"`. 2 righe in `resolve_session.py:169,182` + 4 regression test. Suite 1996→2000.)
