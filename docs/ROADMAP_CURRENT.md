...
> Last updated: 2026-04-22 (B218 — 4 bugfix per Body Part Picker A213: append su slot occupato, sets/reps top-level in session-card, guided session per sessioni inline, warmup block prepended. Suite: 1816 passed.)
