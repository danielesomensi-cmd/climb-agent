...
> Last updated: 2026-03-05 (B88 stable gym_id, B90 load transfer, B91 boulder macrocycle; 736 tests)
...
| Tests | 736 | all green (B88 stable gym_id, B90 load transfer, B91 boulder macrocycle) |
  ...
  src/
    app/
      ...
      (main)/               ← Authenticated pages (with bottom nav)
        ...
        outdoor/page.tsx    ← Outdoor history (stats, sessions, grade histogram)
        whats-next/page.tsx ← Roadmap votabile + feedback form
        settings/page.tsx   ← Profile, goal, equipment, outdoor spots, actions
