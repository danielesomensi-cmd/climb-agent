...
> Last updated: 2026-02-28 (C-1/C-2/C-3/C-4 UI consistency + gym change; 145 exercises, 25 sessions, 20 templates, 514 tests)
...
| Tests | 514 | all green (post UI consistency + gym change) |
