...
|---|---|---|---|
| "phase", "deload", "macrocycle", "periodization", "4-3-2-1", "DUP", "base", "build", "peak", "fase", "scarico", "macrociclo", "ciclo", "periodizzazione", "picco" | `L3/01_periodization.md` | UC1 | ~6,000 |
...
| "pull-up", "pulling", "weighted pull", "lock-off", "contact strength", "trazion*", "bloccagg*" | `L3/03_pulling_strength.md` | UC3 | ~3,500 |
...
| "technique", "drill*", "footwork", "silent feet", "movement", "skill", "motor learning", "warm-up", "warmup", "tecnica", "piedi", "movimento", "riscaldamento", "scaldar*" | `L3/06_technique_movement.md` | UC6 | ~7,000 |
...
| "eat", "nutrition", "macros", "supplement", "creatine", "collagen", "protein", "carbs", "weight", "diet", "low-carb", "mangi*", "nutrizione", "alimentazione", "integratori", "proteine", "carboidrati", "dieta", "dimagrire", "peso", "perdere peso" | `L3/08_nutrition.md` | UC8 | ~4,000 |
| "recovery", "sleep", "rest day", "G-Tox", "active rest", "recupero", "sonno", "riposo", "dorm*" | `L3/09_recovery_sleep.md` | UC9 | ~4,000 |
| "pulley", "finger pain", "tweak", "lumbrical", "A2", "A4", "tendon", "crimp injury", "puleggia", "dolore", "tendine", "infortunio", "dita", "tacca", "warm-up", "warmup", "riscaldamento", "scaldar*" | `L3/10_injuries_fingers.md` | UC10 | ~6,000 |
...
| "cycle", "menstrual", "female", "woman", "youth", "kid", "teen", "older", "40+", "age", "ciclo mestruale", "mestrual*", "ciclo", "donna", "giovani", "adolescente", "anziano" | `L3/14_female_age_youth.md` | UC14 | ~4,000 |
...
| "tired", "ready", "RPE", "overtraining", "ACWR", "feel off", "HRV", "resting HR", "stanc*", "sovrallenamento", "affatic*" | `L3/17_readiness_overtraining.md` | UC17/UC21 | ~3,500 |
...
| "back to training", "break", "off", "detraining", "return", "restart", "illness", "injury return", "ripresa", "ritorno", "pausa", "malattia", "influenza", "infortunio", "riprend*", "ripart*", "saltato", "fermo" | `L3/20_return_to_training.md` | UC23 | ~3,000 |
...
2. **Match** each L3 row's keyword set; count keyword occurrences (any match counts as +1, multiple keywords in same row count once). A keyword written with a trailing `*` is a **stem**: it matches any token starting with it. Italian is inflected — a user types "dormo", never the infinitive "dormire" — so write the stem (`dorm*`) whenever the word has common inflected forms. Same for English plurals (`drill*`). Minimum stem length: 4 characters (B310).
