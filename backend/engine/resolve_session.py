...
def suggest_max_hang_load(user_state: Optional[Dict[str, Any]], prescription: Dict[str, Any], exercise_attrs: Optional[Dict[str, Any]] = None) -> Optional[Dict[str, Any]]:
    ...
    edge_mm = 20
    grip = "half_crimp"
    hang_seconds = int(prescription.get("work_seconds") or prescription.get("hang_seconds") or prescription.get("hang_seconds_range", [7])[0] or 7)
...
def load_user_state(repo_root: str) -> Optional[Dict[str, Any]]:
    p = os.path.join(repo_root, "backend/data/user_state.json")
    if os.path.exists(p):
        return load_json(p)
    return None
    ...
    *,
    ...
    if selected_ex:
        ...
        inst = {
            ...
            "video_url": selected_ex.get("video_url") or None,
            "cues": selected_ex.get("cues") or [],
            "variant": {},
            "prescription": merged,
            "attributes": ex_attrs,
    ...
    *,
    ...
    for zone in prehab_zones:
        ...
        inst = {
            ...
            "alt_sides": bool(prehab_ex.get("alt_sides")),
